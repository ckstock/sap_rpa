    ...
    let tCodes = [
      ...
      { code: "ZFI072N", name: "维护采购价", module: "FI", stage: "顺序执行", script: "ZFI072N.vbs", icon: "receipt-text", params: ["plants", "period", "weekEnd"], factoryRule: "按选中工厂执行；过账日期按上一完整周推导，跨月时 VBS 连续执行两段过账日期窗口", defaultPlantGroup: "PINGHU_ALL", automation: "script", timeout: 1200, retry: 2, enabled: true },
      ...
      { code: "ZFI080B", name: "工费率保存", module: "FI", stage: "周结推送", script: "ZFI080B.vbs", icon: "calculator", params: ["plants", "period", "weekEnd"], factoryRule: "按选中工厂和上一完整周过账日期保存", defaultPlantGroup: "PINGHU_ALL", automation: "script", timeout: 1200, retry: 2, enabled: true },
